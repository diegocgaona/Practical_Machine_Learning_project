...
**Observation:** in this fiel, I only loaded my models from my previous trained models, some models take more than one hour to execute, because of that, I put some part as comments.  
```{r training_models}
